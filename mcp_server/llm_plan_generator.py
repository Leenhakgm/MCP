...
class LLMPlanGenerator:
    ...
    def detect_secrets_in_file(
        ...
        prompt = (
            ...
            "Your task is to detect ALL hardcoded secrets inside the file.\n\n"
            ...
            "- secrets inside JSON\n"
            "- secrets inside URLs\n"
            "- long random strings used for authentication\n"
            ...
            "- Do not stop after finding one secret.\n"
            "- Return ALL secrets you detect.\n\n"
